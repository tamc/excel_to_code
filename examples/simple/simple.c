...
ExcelValue inputs_a1();
ExcelValue inputs_b1();
ExcelValue inputs_a2();
ExcelValue inputs_b2();
ExcelValue inputs_a4();
ExcelValue inputs_b4();
ExcelValue outputs_a1();
ExcelValue outputs_a2();
ExcelValue outputs_a3();
// starting the value constants
static ExcelValue constant1 = {.type = ExcelString, .string = "Your first name:"};
static ExcelValue constant2 = {.type = ExcelString, .string = "Harry"};
static ExcelValue constant3 = {.type = ExcelString, .string = "Your surname:"};
static ExcelValue constant4 = {.type = ExcelString, .string = "Potter"};
static ExcelValue constant5 = {.type = ExcelString, .string = "What is the meaning of life?"};
static ExcelValue constant6 = {.type = ExcelNumber, .number = 24.0};
static ExcelValue constant7 = {.type = ExcelString, .string = "Hello "};
static ExcelValue constant8 = {.type = ExcelString, .string = " "};
static ExcelValue constant9 = {.type = ExcelNumber, .number = 42.0};
static ExcelValue constant10 = {.type = ExcelString, .string = "Well done, you know the meaning of life"};
static ExcelValue constant11 = {.type = ExcelString, .string = "Oh dear, that isn't the meaning of life. Guess again."};
static ExcelValue constant12 = {.type = ExcelString, .string = "You were "};
static ExcelValue constant13 = {.type = ExcelString, .string = " out."};
// ending the value constants

ExcelValue inputs_a1() { return constant1; }
ExcelValue inputs_b1_default() {
  return constant2;
}
static ExcelValue inputs_b1_variable;
ExcelValue inputs_b1() { if(variable_set[1] == 1) { return inputs_b1_variable; } else { return inputs_b1_default(); } }
void set_inputs_b1(ExcelValue newValue) { variable_set[1] = 1; inputs_b1_variable = newValue; }

ExcelValue inputs_a2() { return constant3; }
ExcelValue inputs_b2_default() {
  return constant4;
}
static ExcelValue inputs_b2_variable;
ExcelValue inputs_b2() { if(variable_set[3] == 1) { return inputs_b2_variable; } else { return inputs_b2_default(); } }
void set_inputs_b2(ExcelValue newValue) { variable_set[3] = 1; inputs_b2_variable = newValue; }

ExcelValue inputs_a4() { return constant5; }
ExcelValue inputs_b4_default() {
  return constant6;
}
static ExcelValue inputs_b4_variable;
ExcelValue inputs_b4() { if(variable_set[5] == 1) { return inputs_b4_variable; } else { return inputs_b4_default(); } }
void set_inputs_b4(ExcelValue newValue) { variable_set[5] = 1; inputs_b4_variable = newValue; }

ExcelValue outputs_a1() {
  static ExcelValue result;
  if(variable_set[6] == 1) { return result;}
  ExcelValue array0[] = {constant7,inputs_b1(),constant8,inputs_b2()};
  result = string_join(4, array0);
  variable_set[6] = 1;
  return result;
}
...
ExcelValue outputs_a2() {
  ...
  ExcelValue condition0 = excel_equal(inputs_b4(),constant9);
  ExcelValue ifresult0;
  switch(condition0.type) {
  case ExcelBoolean:
    if(condition0.number == true) {
      ifresult0 = constant10;
    } else {
      ifresult0 = constant11;
    }
    break;
  case ExcelNumber:
...
ExcelValue outputs_a3() {
  ...
  ExcelValue array0[] = {constant12,excel_abs(subtract(constant9,inputs_b4())),constant13};
  result = string_join(3, array0);
  variable_set[8] = 1;
  return result;
}
