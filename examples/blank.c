// /Users/tamc/Documents/github/excel_to_code/examples/blank.xlsx approximately translated into C
...
// definitions
ExcelValue sheet1_a1();
ExcelValue sheet1_a2();
// end of definitions

// Used to decide whether to recalculate a cell
static int variable_set[2];
void reset() {
  int i;
  cell_counter = 0;
  for(i = 0; i < 2; i++) {
...
// start Sheet1
ExcelValue sheet1_a1_default() {
  return BLANK;
}
static ExcelValue sheet1_a1_variable;
ExcelValue sheet1_a1() { if(variable_set[0] == 1) { return sheet1_a1_variable; } else { return sheet1_a1_default(); } }
void set_sheet1_a1(ExcelValue newValue) { variable_set[0] = 1; sheet1_a1_variable = newValue; }
