...
class Replaceblanks
  ...
  module C 
    extend FFI::Library
    ffi_lib  File.join(File.dirname(__FILE__),FFI.map_library_name('replaceblanks'))
    ...
    attach_function 'set_sheet1_c3', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c4', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c5', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c6', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c7', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c8', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c9', [ExcelValue.by_value], :void
    attach_function 'set_sheet1_c10', [ExcelValue.by_value], :void
    attach_function 'sheet1_c3', [], ExcelValue.by_value
    attach_function 'sheet1_c4', [], ExcelValue.by_value
    attach_function 'sheet1_c5', [], ExcelValue.by_value
    attach_function 'sheet1_c6', [], ExcelValue.by_value
    attach_function 'sheet1_c7', [], ExcelValue.by_value
    attach_function 'sheet1_c8', [], ExcelValue.by_value
    attach_function 'sheet1_c9', [], ExcelValue.by_value
    attach_function 'sheet1_c10', [], ExcelValue.by_value
    # end of Sheet1
    attach_function 'sheet2_g19', [], ExcelValue.by_value
    attach_function 'sheet2_g20', [], ExcelValue.by_value
    attach_function 'sheet2_g21', [], ExcelValue.by_value
    attach_function 'sheet2_g22', [], ExcelValue.by_value
    attach_function 'sheet2_g23', [], ExcelValue.by_value
    attach_function 'sheet2_g24', [], ExcelValue.by_value
    attach_function 'sheet2_g25', [], ExcelValue.by_value
    attach_function 'sheet2_g26', [], ExcelValue.by_value
    # end of Sheet2
    # Start of named references
    attach_function 'input', [], ExcelValue.by_value
    attach_function 'output', [], ExcelValue.by_value
    attach_function 'input', [], ExcelValue.by_value
    attach_function 'output', [], ExcelValue.by_value
    attach_function 'set_input', [ExcelValue.by_value], :void
