# coding: utf-8
# All tests for /Users/jack/Workspace/excel_to_code/spec/test_data/ExampleSpreadsheet.xlsx
...
class TestRubyExampleSpreadsheet < Minitest::Unit::TestCase
  ...
  def test_valuetypes_a2; assert_equal("Hello", worksheet.valuetypes_a2.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_valuetypes_a6; assert_equal("Hello", worksheet.valuetypes_a6.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_a1; assert_equal("Simple", worksheet.formulaetypes_a1.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b1; assert_in_epsilon(2.0, worksheet.formulaetypes_b1, 0.002); end
  def test_formulaetypes_a2; assert_equal("Sharing", worksheet.formulaetypes_a2.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b2; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b2, 0.002); end
  def test_formulaetypes_a3; assert_equal("Shared", worksheet.formulaetypes_a3.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b3; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b3, 0.002); end
  def test_formulaetypes_a4; assert_equal("Shared", worksheet.formulaetypes_a4.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b4; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b4, 0.002); end
  def test_formulaetypes_a5; assert_equal("Array (single)", worksheet.formulaetypes_a5.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b5; assert_in_epsilon(2.0, worksheet.formulaetypes_b5, 0.002); end
  def test_formulaetypes_a6; assert_equal("Arraying (multiple)", worksheet.formulaetypes_a6.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b6; assert_equal("Not Eight", worksheet.formulaetypes_b6.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_a7; assert_equal("Arrayed (multiple)", worksheet.formulaetypes_a7.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b7; assert_equal("Not Eight", worksheet.formulaetypes_b7.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_a8; assert_equal("Arrayed (multiple)", worksheet.formulaetypes_a8.to_s.gsub(/[\n\r]+/,'')); end
  def test_formulaetypes_b8; assert_equal("Not Eight", worksheet.formulaetypes_b8.to_s.gsub(/[\n\r]+/,'')); end
  def test_ranges_b1; assert_equal("This sheet", worksheet.ranges_b1.to_s.gsub(/[\n\r]+/,'')); end
  def test_ranges_c1; assert_equal("Other sheet", worksheet.ranges_c1.to_s.gsub(/[\n\r]+/,'')); end
  def test_ranges_a2; assert_equal("Standard", worksheet.ranges_a2.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ranges_a3; assert_equal("Column", worksheet.ranges_a3.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ranges_a4; assert_equal("Row", worksheet.ranges_a4.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_b9; assert_in_delta(0.0, (worksheet.referencing_b9||0), 0.002); end
  def test_referencing_b11; assert_equal("Named", worksheet.referencing_b11.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_c11; assert_equal("Reference", worksheet.referencing_c11.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_c31; assert_equal("Technology efficiencies -- hot water -- annual mean", worksheet.referencing_c31.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_o31; assert_equal("% of input energy", worksheet.referencing_o31.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_f33; assert_equal("Electricity (delivered to end user)", worksheet.referencing_f33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g33; assert_equal("Electricity (supplied to grid)", worksheet.referencing_g33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_h33; assert_equal("Solid hydrocarbons", worksheet.referencing_h33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_i33; assert_equal("Liquid hydrocarbons", worksheet.referencing_i33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_j33; assert_equal("Gaseous hydrocarbons", worksheet.referencing_j33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_k33; assert_equal("Heat transport", worksheet.referencing_k33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_l33; assert_equal("Environmental heat", worksheet.referencing_l33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_m33; assert_equal("Heating & cooling", worksheet.referencing_m33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_n33; assert_equal("Conversion losses", worksheet.referencing_n33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_o33; assert_equal("Balance", worksheet.referencing_o33.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_c34; assert_equal("Code", worksheet.referencing_c34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_d34; assert_equal("Technology", worksheet.referencing_d34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e34; assert_equal("Notes", worksheet.referencing_e34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_f34; assert_equal("V.01", worksheet.referencing_f34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g34; assert_equal("V.02", worksheet.referencing_g34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_h34; assert_equal("V.03", worksheet.referencing_h34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_i34; assert_equal("V.04", worksheet.referencing_i34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_j34; assert_equal("V.05", worksheet.referencing_j34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_k34; assert_equal("V.07", worksheet.referencing_k34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_l34; assert_equal("R.07", worksheet.referencing_l34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_m34; assert_equal("H.01", worksheet.referencing_m34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_n34; assert_equal("X.01", worksheet.referencing_n34.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_c35; assert_in_delta(1.0, worksheet.referencing_c35, 0.002); end
  def test_referencing_d35; assert_equal("Gas boiler (old)", worksheet.referencing_d35.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d36; assert_equal("Gas boiler (new)", worksheet.referencing_d36.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d37; assert_equal("Resistive heating", worksheet.referencing_d37.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d38; assert_equal("Oil-fired boiler", worksheet.referencing_d38.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d39; assert_equal("Solid-fuel boiler", worksheet.referencing_d39.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e39; assert_equal("[2]", worksheet.referencing_e39.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d40; assert_equal("Stirling engine micro-CHP", worksheet.referencing_d40.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e40; assert_equal("[3]", worksheet.referencing_e40.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d41; assert_equal("Fuel-cell micro-CHP", worksheet.referencing_d41.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e41; assert_equal("[3]", worksheet.referencing_e41.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d42; assert_equal("Air-source heat pump", worksheet.referencing_d42.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d43; assert_equal("Ground-source heat pump", worksheet.referencing_d43.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d44; assert_equal("Geothermal electricity", worksheet.referencing_d44.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d45; assert_equal("Community scale gas CHP with local district heating", worksheet.referencing_d45.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d46; assert_equal("Community scale solid-fuel CHP with local district heating", worksheet.referencing_d46.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d47; assert_equal("Long distance district heating from large power stations", worksheet.referencing_d47.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e47; assert_equal("[6]", worksheet.referencing_e47.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_referencing_d50; assert_equal("Gas boiler (old)", worksheet.referencing_d50.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g50; assert_in_epsilon(137.26515207025273, worksheet.referencing_g50, 0.002); end
  def test_referencing_d51; assert_equal("Gas boiler (new)", worksheet.referencing_d51.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g51; assert_in_epsilon(30.731004194832696, worksheet.referencing_g51, 0.002); end
  def test_referencing_d52; assert_equal("Resistive heating", worksheet.referencing_d52.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g52; assert_in_epsilon(20.487336129888465, worksheet.referencing_g52, 0.002); end
  def test_referencing_d53; assert_equal("Oil-fired boiler", worksheet.referencing_d53.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g53; assert_in_epsilon(8.194934451955387, worksheet.referencing_g53, 0.002); end
  def test_referencing_d54; assert_equal("Solid-fuel boiler", worksheet.referencing_d54.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g54; assert_in_epsilon(8.194934451955387, worksheet.referencing_g54, 0.002); end
  def test_referencing_d55; assert_equal("Stirling engine micro-CHP", worksheet.referencing_d55.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g55; assert_in_delta(0.0, (worksheet.referencing_g55||0), 0.002); end
  def test_referencing_d56; assert_equal("Fuel-cell micro-CHP", worksheet.referencing_d56.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g56; assert_in_delta(0.0, (worksheet.referencing_g56||0), 0.002); end
  def test_referencing_d57; assert_equal("Air-source heat pump", worksheet.referencing_d57.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g57; assert_in_delta(0.0, (worksheet.referencing_g57||0), 0.002); end
  def test_referencing_d58; assert_equal("Ground-source heat pump", worksheet.referencing_d58.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g58; assert_in_delta(0.0, (worksheet.referencing_g58||0), 0.002); end
  def test_referencing_d59; assert_equal("Geothermal electricity", worksheet.referencing_d59.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g59; assert_in_delta(0.0, (worksheet.referencing_g59||0), 0.002); end
  def test_referencing_d60; assert_equal("Community scale gas CHP with local district heating", worksheet.referencing_d60.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g60; assert_in_delta(0.0, (worksheet.referencing_g60||0), 0.002); end
  def test_referencing_d61; assert_equal("Community scale solid-fuel CHP with local district heating", worksheet.referencing_d61.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g61; assert_in_delta(0.0, (worksheet.referencing_g61||0), 0.002); end
  def test_referencing_d62; assert_equal("Long distance district heating from large power stations", worksheet.referencing_d62.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_g62; assert_in_delta(0.0, (worksheet.referencing_g62||0), 0.002); end
  def test_referencing_d64; assert_equal("H.01", worksheet.referencing_d64.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_e64; assert_equal("Heating & cooling", worksheet.referencing_e64.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_h64; assert_in_epsilon(204.87336129888465, worksheet.referencing_h64, 0.002); end
  def test_referencing_e68; assert_equal("Alpha", worksheet.referencing_e68.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_f68; assert_in_delta(1.0, worksheet.referencing_f68, 0.002); end
  def test_referencing_e69; assert_equal("Beta", worksheet.referencing_e69.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_f69; assert_in_epsilon(2.0, worksheet.referencing_f69, 0.002); end
  def test_referencing_e70; assert_equal("Gamma", worksheet.referencing_e70.to_s.gsub(/[\n\r]+/,'')); end
  def test_referencing_f70; assert_in_epsilon(3.0, worksheet.referencing_f70, 0.002); end
  def test_referencing_e72; assert_equal("Beta", worksheet.referencing_e72.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_tables_b2; assert_equal("ColA", worksheet.tables_b2.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_c2; assert_equal("ColB", worksheet.tables_c2.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_d2; assert_equal("Column1", worksheet.tables_d2.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_b3; assert_equal("A", worksheet.tables_b3.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_c3; assert_equal("A", worksheet.tables_c3.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_d3; assert_equal("AA", worksheet.tables_d3.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_b4; assert_equal("Z", worksheet.tables_b4.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_c4; assert_equal("B", worksheet.tables_c4.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_d4; assert_equal("ZB", worksheet.tables_d4.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_f4; assert_equal("B", worksheet.tables_f4.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_tables_b5; assert_in_delta(0.0, (worksheet.tables_b5||0), 0.002); end
  def test_tables_c5; assert_in_delta(0.0, (worksheet.tables_c5||0), 0.002); end
  def test_tables_e6; assert_equal("ColA", worksheet.tables_e6.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_f6; assert_equal("ColB", worksheet.tables_f6.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_g6; assert_equal("Column1", worksheet.tables_g6.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_e7; assert_in_delta(0.0, (worksheet.tables_e7||0), 0.002); end
  ...
  def test_tables_e8; assert_equal("ColA", worksheet.tables_e8.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_f8; assert_equal("ColB", worksheet.tables_f8.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_g8; assert_equal("Column1", worksheet.tables_g8.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_e9; assert_equal("A", worksheet.tables_e9.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_f9; assert_equal("A", worksheet.tables_f9.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_g9; assert_equal("AA", worksheet.tables_g9.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_c10; assert_in_delta(0.0, (worksheet.tables_c10||0), 0.002); end
  def test_tables_e10; assert_equal("Z", worksheet.tables_e10.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_f10; assert_equal("B", worksheet.tables_f10.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_g10; assert_equal("ZB", worksheet.tables_g10.to_s.gsub(/[\n\r]+/,'')); end
  def test_tables_c11; assert_in_delta(0.0, (worksheet.tables_c11||0), 0.002); end
  def test_tables_e11; assert_in_delta(0.0, (worksheet.tables_e11||0), 0.002); end
  ...
  def test_tables_c12; assert_in_delta(0.0, (worksheet.tables_c12||0), 0.002); end
  def test_tables_c13; assert_in_delta(0.0, (worksheet.tables_c13||0), 0.002); end
  def test_tables_c14; assert_in_delta(0.0, (worksheet.tables_c14||0), 0.002); end
  def test_tables_g17; assert_equal(false, worksheet.tables_g17); end
