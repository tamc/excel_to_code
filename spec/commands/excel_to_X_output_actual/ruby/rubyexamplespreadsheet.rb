...
class RubyExampleSpreadsheet
  ...
  def ranges_b3; @ranges_b3 ||= sum(0.0,0.0,0.0,ranges_f4,ranges_f5,ranges_f6); end
  ...
  def referencing_b9; @referencing_b9 ||= ensure_is_number([[tables_b5,tables_c5,0]]); end
  ...
  def referencing_d22; @referencing_d22 ||= index(common1,1.0,1.0); end
  def referencing_d23; @referencing_d23 ||= index(common1,2.0,1.0); end
  def referencing_d24; @referencing_d24 ||= index(common1,3.0,1.0); end
  def referencing_d25; @referencing_d25 ||= index(common1,4.0,1.0); end
  ...
  def referencing_f72; @referencing_f72 ||= common25; end
  def referencing_g72; @referencing_g72 ||= common25; end
  ...
  def tables_b5; @tables_b5 ||= common32; end
  ...
  def tables_c13; @tables_c13 ||= common33; end
  def tables_c14; @tables_c14 ||= common33; end
  ...
  def ranges_f3; @ranges_f3 ||= nil; end
  def ranges_a5; @ranges_a5 ||= nil; end
  def ranges_b5; @ranges_b5 ||= nil; end
  def ranges_c5; @ranges_c5 ||= nil; end
  def ranges_d5; @ranges_d5 ||= nil; end
  def referencing_f35; @referencing_f35 ||= nil; end
  def referencing_g35; @referencing_g35 ||= nil; end
  def referencing_h35; @referencing_h35 ||= nil; end
  def referencing_i35; @referencing_i35 ||= nil; end
  def referencing_k35; @referencing_k35 ||= nil; end
  def referencing_l35; @referencing_l35 ||= nil; end
  def referencing_f36; @referencing_f36 ||= nil; end
  def referencing_g36; @referencing_g36 ||= nil; end
  def referencing_h36; @referencing_h36 ||= nil; end
  def referencing_i36; @referencing_i36 ||= nil; end
  def referencing_k36; @referencing_k36 ||= nil; end
  def referencing_l36; @referencing_l36 ||= nil; end
  def referencing_g37; @referencing_g37 ||= nil; end
  def referencing_h37; @referencing_h37 ||= nil; end
  def referencing_i37; @referencing_i37 ||= nil; end
  def referencing_j37; @referencing_j37 ||= nil; end
  def referencing_k37; @referencing_k37 ||= nil; end
  def referencing_l37; @referencing_l37 ||= nil; end
  def referencing_f38; @referencing_f38 ||= nil; end
  def referencing_g38; @referencing_g38 ||= nil; end
  def referencing_h38; @referencing_h38 ||= nil; end
  def referencing_j38; @referencing_j38 ||= nil; end
  def referencing_k38; @referencing_k38 ||= nil; end
  def referencing_l38; @referencing_l38 ||= nil; end
  def referencing_f39; @referencing_f39 ||= nil; end
  def referencing_g39; @referencing_g39 ||= nil; end
  def referencing_i39; @referencing_i39 ||= nil; end
  def referencing_j39; @referencing_j39 ||= nil; end
  def referencing_k39; @referencing_k39 ||= nil; end
  def referencing_l39; @referencing_l39 ||= nil; end
  def referencing_f40; @referencing_f40 ||= nil; end
  def referencing_h40; @referencing_h40 ||= nil; end
  def referencing_i40; @referencing_i40 ||= nil; end
  def referencing_k40; @referencing_k40 ||= nil; end
  def referencing_l40; @referencing_l40 ||= nil; end
  def referencing_f41; @referencing_f41 ||= nil; end
  def referencing_h41; @referencing_h41 ||= nil; end
  def referencing_i41; @referencing_i41 ||= nil; end
  def referencing_k41; @referencing_k41 ||= nil; end
  def referencing_l41; @referencing_l41 ||= nil; end
  def referencing_g42; @referencing_g42 ||= nil; end
  def referencing_h42; @referencing_h42 ||= nil; end
  def referencing_i42; @referencing_i42 ||= nil; end
  def referencing_j42; @referencing_j42 ||= nil; end
  def referencing_k42; @referencing_k42 ||= nil; end
  def referencing_n42; @referencing_n42 ||= nil; end
  def referencing_g43; @referencing_g43 ||= nil; end
  def referencing_h43; @referencing_h43 ||= nil; end
  def referencing_i43; @referencing_i43 ||= nil; end
  def referencing_j43; @referencing_j43 ||= nil; end
  def referencing_k43; @referencing_k43 ||= nil; end
  def referencing_n43; @referencing_n43 ||= nil; end
  def referencing_f44; @referencing_f44 ||= nil; end
  def referencing_g44; @referencing_g44 ||= nil; end
  def referencing_h44; @referencing_h44 ||= nil; end
  def referencing_i44; @referencing_i44 ||= nil; end
  def referencing_j44; @referencing_j44 ||= nil; end
  def referencing_k44; @referencing_k44 ||= nil; end
  def referencing_f45; @referencing_f45 ||= nil; end
  def referencing_h45; @referencing_h45 ||= nil; end
  def referencing_i45; @referencing_i45 ||= nil; end
  def referencing_k45; @referencing_k45 ||= nil; end
  def referencing_l45; @referencing_l45 ||= nil; end
  def referencing_f46; @referencing_f46 ||= nil; end
  def referencing_i46; @referencing_i46 ||= nil; end
  def referencing_j46; @referencing_j46 ||= nil; end
  def referencing_k46; @referencing_k46 ||= nil; end
  def referencing_l46; @referencing_l46 ||= nil; end
  def referencing_f47; @referencing_f47 ||= nil; end
  def referencing_g47; @referencing_g47 ||= nil; end
  def referencing_h47; @referencing_h47 ||= nil; end
  ...
  def common1; @common1 ||= index([[referencing_c16,referencing_d16,referencing_e16,referencing_f16],[referencing_c17,referencing_d17,referencing_e17,referencing_f17],[referencing_c18,referencing_d18,referencing_e18,referencing_f18],[referencing_c19,referencing_d19,referencing_e19,referencing_f19]],nil,excel_match(referencing_c22,[[referencing_c15,referencing_d15,referencing_e15,referencing_f15]],0.0)); end
  def common5; @common5 ||= divide(referencing_g50,referencing_m35); end
  def common6; @common6 ||= excel_equal?(referencing_d64,referencing_j34); end
  def common7; @common7 ||= excel_equal?(referencing_d64,referencing_m34); end
  def common8; @common8 ||= excel_equal?(referencing_d64,referencing_n34); end
  def common9; @common9 ||= divide(referencing_g51,referencing_m36); end
  def common10; @common10 ||= divide(referencing_g52,referencing_m37); end
  def common11; @common11 ||= excel_equal?(referencing_d64,referencing_f34); end
  def common12; @common12 ||= divide(referencing_g53,referencing_m38); end
  def common13; @common13 ||= divide(referencing_g54,referencing_m39); end
  def common14; @common14 ||= excel_equal?(referencing_d64,referencing_h34); end
  def common15; @common15 ||= divide(referencing_g55,referencing_m40); end
  def common16; @common16 ||= excel_equal?(referencing_d64,referencing_g34); end
  def common17; @common17 ||= divide(referencing_g56,referencing_m41); end
  def common18; @common18 ||= divide(referencing_g57,referencing_m42); end
  def common19; @common19 ||= excel_equal?(referencing_d64,referencing_l34); end
  def common20; @common20 ||= divide(referencing_g58,referencing_m43); end
  def common21; @common21 ||= divide(referencing_g59,referencing_m44); end
  def common22; @common22 ||= divide(referencing_g60,referencing_m45); end
  def common23; @common23 ||= divide(referencing_g61,referencing_m46); end
  def common24; @common24 ||= divide(referencing_g62,referencing_m47); end
  def common25; @common25 ||= sum(multiply(excel_equal?(referencing_e72,referencing_e68),referencing_f68),multiply(excel_equal?(referencing_e72,referencing_e69),referencing_f69),multiply(excel_equal?(referencing_e72,referencing_e70),referencing_f70)); end
  def common32; @common32 ||= sum(tables_b3,tables_b4); end
  def common33; @common33 ||= sum(tables_b3,tables_c3,tables_d3,tables_b4,tables_c4,tables_d4); end
