...
class TestExampleSpreadsheet < Minitest::Test
  ...
  def test_valuetypes_a3; assert_in_delta(1, worksheet.valuetypes_a3, 0.001); end
  def test_valuetypes_a4; assert_in_epsilon(3.1415, worksheet.valuetypes_a4, 0.001); end
  ...
  def test_formulaetypes_b1; assert_in_epsilon(2, worksheet.formulaetypes_b1, 0.001); end
  def test_formulaetypes_a2; assert_equal("Sharing", worksheet.formulaetypes_a2); end
  def test_formulaetypes_b2; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b2, 0.001); end
  def test_formulaetypes_a3; assert_equal("Shared", worksheet.formulaetypes_a3); end
  def test_formulaetypes_b3; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b3, 0.001); end
  def test_formulaetypes_a4; assert_equal("Shared", worksheet.formulaetypes_a4); end
  def test_formulaetypes_b4; assert_in_epsilon(267.7467614837482, worksheet.formulaetypes_b4, 0.001); end
  def test_formulaetypes_a5; assert_equal("Array (single)", worksheet.formulaetypes_a5); end
  def test_formulaetypes_b5; assert_in_epsilon(2, worksheet.formulaetypes_b5, 0.001); end
  ...
  def test_ranges_b2; assert_in_epsilon(6, worksheet.ranges_b2, 0.001); end
  def test_ranges_c2; assert_in_epsilon(4.141500000000001, worksheet.ranges_c2, 0.001); end
  def test_ranges_a3; assert_equal("Column", worksheet.ranges_a3); end
  def test_ranges_b3; assert_in_epsilon(6, worksheet.ranges_b3, 0.001); end
  def test_ranges_c3; assert_equal(:name, worksheet.ranges_c3); end
  def test_ranges_a4; assert_equal("Row", worksheet.ranges_a4); end
  def test_ranges_b4; assert_in_epsilon(6, worksheet.ranges_b4, 0.001); end
  def test_ranges_c4; assert_in_epsilon(3.1415, worksheet.ranges_c4, 0.001); end
  def test_ranges_f4; assert_in_delta(1, worksheet.ranges_f4, 0.001); end
  def test_ranges_e5; assert_in_delta(1, worksheet.ranges_e5, 0.001); end
  def test_ranges_f5; assert_in_epsilon(2, worksheet.ranges_f5, 0.001); end
  def test_ranges_g5; assert_in_epsilon(3, worksheet.ranges_g5, 0.001); end
  def test_ranges_f6; assert_in_epsilon(3, worksheet.ranges_f6, 0.001); end
  ...
  def test_referencing_b9; assert_in_epsilon(3, worksheet.referencing_b9, 0.001); end
  ...
  def test_tables_a1; assert_in_delta(0, (worksheet.tables_a1||0), 0.001); end
  ...
  def test_tables_b3; assert_in_delta(1, worksheet.tables_b3, 0.001); end
  def test_tables_c3; assert_equal("A", worksheet.tables_c3); end
  def test_tables_d3; assert_equal("1A", worksheet.tables_d3); end
  def test_tables_b4; assert_in_epsilon(2, worksheet.tables_b4, 0.001); end
  ...
  def test_tables_g4; assert_in_epsilon(3, worksheet.tables_g4, 0.001); end
  def test_tables_h4; assert_in_delta(1, worksheet.tables_h4, 0.001); end
  def test_tables_b5; assert_in_epsilon(3, worksheet.tables_b5, 0.001); end
  def test_tables_c5; assert_in_delta(0, (worksheet.tables_c5||0), 0.001); end
  ...
  def test_tables_e7; assert_in_epsilon(3, worksheet.tables_e7, 0.001); end
  def test_tables_f7; assert_in_delta(0, (worksheet.tables_f7||0), 0.001); end
  def test_tables_g7; assert_in_delta(0, (worksheet.tables_g7||0), 0.001); end
  ...
  def test_tables_e9; assert_in_delta(1, worksheet.tables_e9, 0.001); end
  def test_tables_f9; assert_equal("A", worksheet.tables_f9); end
  def test_tables_g9; assert_equal("1A", worksheet.tables_g9); end
  def test_tables_c10; assert_in_epsilon(3, worksheet.tables_c10, 0.001); end
  def test_tables_e10; assert_in_epsilon(2, worksheet.tables_e10, 0.001); end
  def test_tables_f10; assert_equal("B", worksheet.tables_f10); end
  def test_tables_g10; assert_equal("2B", worksheet.tables_g10); end
  def test_tables_c11; assert_in_epsilon(3, worksheet.tables_c11, 0.001); end
  def test_tables_e11; assert_in_epsilon(3, worksheet.tables_e11, 0.001); end
  def test_tables_f11; assert_in_delta(0, (worksheet.tables_f11||0), 0.001); end
  def test_tables_g11; assert_in_delta(0, (worksheet.tables_g11||0), 0.001); end
  def test_tables_c12; assert_in_epsilon(3, worksheet.tables_c12, 0.001); end
