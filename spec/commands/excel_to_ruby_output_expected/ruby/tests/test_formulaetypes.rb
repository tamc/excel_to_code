...
class TestFormulaetypes < Test::Unit::TestCase
  ...
  def test_b2; assert_in_epsilon(267.7467614837482,worksheet.b2); end
  def test_a3; assert_equal("Shared",worksheet.a3); end
  def test_b3; assert_in_epsilon(267.7467614837482,worksheet.b3); end
  def test_a4; assert_equal("Shared",worksheet.a4); end
  def test_b4; assert_in_epsilon(267.7467614837482,worksheet.b4); end
  def test_a5; assert_equal("Array (single)",worksheet.a5); end
  def test_b5; assert_in_epsilon(2,worksheet.b5); end
